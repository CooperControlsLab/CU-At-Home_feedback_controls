...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        self.setLayout(mainLayout)
        self.timer = QTimer()
        self.timer.setInterval(0.0001) #Changes the plot speed
...
# establish serial connection after UI initialize
    ...
    def hand_shake(self):
        ...
        value = ser.readline().decode().replace('\r\n','')
        print(value)
